        ...
        <Tabs defaultValue="hard-skills" className="space-y-6">
          ...
          <TabsContent value="hard-skills" className="space-y-4">
            <Tabs defaultValue="categories" className="space-y-4">
              ...
              <TabsContent value="categories"><CategorySkillsManagement /></TabsContent>
              <TabsContent value="subcategories"><SubCategoryHardSkillsManagement /></TabsContent>
          ...
          <TabsContent value="soft-skills" className="space-y-4">
            <Tabs defaultValue="categories" className="space-y-4">
              ...
              <TabsContent value="categories"><CategorySoftSkillsManagement /></TabsContent>
              <TabsContent value="subcategories"><SubCategorySoftSkillsManagement /></TabsContent>
              <TabsContent value="skills"><QualitiesManagement /></TabsContent>
            </Tabs>
          </TabsContent>
