...
## Purpose
Collapsible app sidebar (w-16↔w-64). Light brand SVG bg; dark theme hides bg. Hover items use color.semantic.sidebar.accent/15. Tokens: color.component.sidebar.*
