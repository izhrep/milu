-- Обновляем функцию admin_cleanup_all_data() для включения user_qualities и user_skills
...
'Admin cleanup function - deletes all operational data including user_qualities and user_skills. Requires security.manage permission.';